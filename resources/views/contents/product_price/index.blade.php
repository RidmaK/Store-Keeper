            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        ...
                        <a href="{{route('price_allocation.create')}}" class="btn btn-primary float-end">
                            {{ __('Add New') }}
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-sm">
                            ...
                            <tbody>
                                @if (count($product_prices) > 0)
                                    ...
                                    <tr>
                                        <th class="text-center" scope="row">{{$price->price_id}}</th>
                                        <td class="text-srart">{{$price->pro_name}}</td>
                                        <td class="text-srart">{{$price->price_code}}</td>
                                        <td class="text-srart">{{$price->price}}</td>
                                        <td class="text-srart">
                                            @if ($price->status == 1)
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <a href="{{route('product.edit', $price->pro_id)}}" class="btn btn-outline-primary">
                                                        {{ __('Edit') }}
                                                    </a>
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            {!! $product_prices->onEachSide(0)->links() !!}
                        </div>
                    </div>
                </div>
            </div>
