...
<body class="bg-gradient-to-r from-purple-800 to-blue-300  h-screen antialiased leading-none font-sans">
<div class="flex flex-col">
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="flex flex-col justify-around h-full">
            <div>
                <h1 class="mb-6 text-white text-center font-light tracking-wider text-4xl sm:mb-8 sm:text-6xl">
